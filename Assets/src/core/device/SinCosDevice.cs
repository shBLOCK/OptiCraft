...
//                 sinBeam = new Beam(space, sinDirection, gridPos, new BeamImage(sinData, 1f)).emit();
//                 cosBeam = new Beam(space, sinDirection.opposite(), gridPos, new BeamImage(cosData, 1f)).emit();
//             }
//         }
//     }
// }